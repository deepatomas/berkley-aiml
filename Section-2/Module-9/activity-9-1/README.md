...
2. Use sequential feature selection to explore model complexity
...
This activity focuses on using the stepwise feature selection approach outlined in video 9.3. Here, your goal is to first generate polynomial features for a degree = 3 model and limit them to a set number using the SequentialFeatureSelection.
...
### How do I open the activity?
 To view the activity, click on the file `coding_activity_9.1.ipynb` in the panel on the left.
