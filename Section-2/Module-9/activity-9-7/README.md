...
6. Select features using Ridge regularization, LASSO regularization, and Sequential Feature Selection
...
### How do I open the activity?
 To view the activity, click on the file `coding_activity_9.7.ipynb` in the panel on the left. 
