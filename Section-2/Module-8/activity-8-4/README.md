...
In this exercise, you will examine the effect of fitting more complex models on the automobile data. Using the Pipeline, you will fit models of degree 1–10 and evaluate the mean squared error of each model. Using these results, you are to generate a plot of the model complexity versus MSE.
...
### How do I open the activity?
 To view the activity, click on the file `coding_activity_8.4.ipynb` in the panel on the left.
