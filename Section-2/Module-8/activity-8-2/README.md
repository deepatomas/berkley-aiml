# Codio Activity 8.2: Using Polynomial Features
...
1. Generate non-linear features for use by a linear model
...
### How do I open the activity?
 To view the activity, click on the file `coding_activity_8.2.ipynb` in the panel on the left. 
