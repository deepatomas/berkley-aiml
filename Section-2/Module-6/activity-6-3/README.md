...
This activity focuses on building a scree plot with Python. A scree plot can be used to determine how many principal components to keep in a given dataset. Using a housing dataset from scikit-learn, you will plot the values of $\Sigma$ in decreasing order, thereby producing a scree plot.
...
### How do I open the activity?
 To view the activity, click on the file `coding_activity_6.3.ipynb` in the panel on the left.
