...
5. Create the k-mean algorithm in Python
...
This activity focuses on initially choosing the center points for each of the clusters. Given three different datasets, you should choose cluster centers that make sense based on the data. Here, you will choose the centers given specific options. Think about a general rather than specific approach to selecting the centers as you work through these examples.
...
### How do I open the activity?
 To view the activity, click on the file `coding_activity_6.5.ipynb` in the panel on the left.
