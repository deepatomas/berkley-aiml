...
This activity focuses on using sklearn to perform k-means clustering. You will compare initialization methods and determine the ‘right’ number of clusters using an elbow plot. The data are again produced using sklearn.
...
### How do I open the activity?
 To view the activity, click on the file `coding_activity_6.7.ipynb` in the panel on the left.
