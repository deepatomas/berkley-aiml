...
10. Compare results of multiple clustering techniques on a given dataset
...
Now that you have seen how to use PCA to reduce the dimensionality of data while maintaining important information and used both K-Means and DBSCAN to cluster simple data, it is time to see how you can apply these ideas to a real dataset. In this activity, you will use a dataset related to marketing campaigns with the task being to identify groups of similar customers. Once the cluster labels are assigned, you will briefly explore inside of each cluster for patterns that help identify characteristics of customers.
...
### How do I open the activity?
 To view the activity, click on the file `codiing_activity_6.9.ipynb` in the panel on the left.
