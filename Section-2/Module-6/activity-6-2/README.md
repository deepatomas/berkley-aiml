...
2. Analyze the result of PCA in a specific context
...
This activity explores PCA through two examples—image data and tabular data. These examples are meant to demonstrate how PCA extracts important information from the data while reducing its dimensionality.
...
### How do I open the activity?
 To view the activity, click on the file `coding_activity_6.2.ipynb` in the panel on the left.
